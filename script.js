...
function checkWinner() {
  ...
  if (homeScore > 50) {
    document.getElementById("winner-message").textContent = "India team won the match!";
  } else if (guestScore > 50) {
    document.getElementById("winner-message").textContent = "Pakistan team won the match!";
  }
}